...
class SiembraController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.camaronera.siembra.index',['siembras'=>$siembra,'laboratorios'=>$laboratorios,'piscinas'=>$piscinas, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function edit($id)
    {
        try{
            ...
            return view('admin.camaronera.siembra.index',['siembra'=>$siembra,'piscinas'=>$piscinas, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
            return redirect('inicio')->with('error2','Ocurrio un error en el procedimiento. Vuelva a intentar. ('.$ex->getMessage().')');
        }
    ...
    public function eliminar($id)
    {
        try{
            ...
            $siembra = Siembra::findOrFail($id);
            return view('admin.camaronera.siembra.index',['siembra'=>$siembra, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
            return redirect('inicio')->with('error2','Ocurrio un error en el procedimiento. Vuelva a intentar. ('.$ex->getMessage().')');
        }
