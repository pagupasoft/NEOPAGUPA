        ...
        try{ 
            ...
            if(count($cajaAbierta) == 0){            
                if(count($cajasxusuarios)>0){
                    return view('admin.caja.arqueoCaja.index',['cajas'=>$cajas,'cajasxusuarios'=>$cajasxusuarios, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
                }else{
