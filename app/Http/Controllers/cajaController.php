...
class cajaController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('admin.caja.caja.index',['cuentas'=>$cuentas, 'sucursales'=>$sucursales, 'cajas'=>$cajas, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
    ...
    public function show($id)
    {
        try {
            ...
            if($caja){
                return view('admin.caja.caja.ver',['cajaUsers'=>$cajaUsers,'usuarios'=>$usuarios,'caja'=>$caja, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
    ...
    public function edit($id)
    {
        try {
            ...
            $sucursales = Sucursal::sucursales()->get();
            if($cajas){
                return view('admin.caja.caja.editar', ['sucursales'=>$sucursales,'cuentas'=>$cuentas, 'caja'=>$cajas, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
    ...
    public function delete($id)
    {
        try {
            ...
            $caja = Caja::caja($id)->first();
            if($caja){
                return view('admin.caja.caja.eliminar',['caja'=>$caja, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
    ...
    public function verusers($id)
    {
        try {
            ...
            $cajaUsers=Caja_Usuario::CajaUsuario($id)->get();    
            if($usuarios){
                return view('admin.caja.caja.verusuario',['caja'=>$caja,'cajaUsers'=>$cajaUsers,'usuarios'=>$usuarios, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
