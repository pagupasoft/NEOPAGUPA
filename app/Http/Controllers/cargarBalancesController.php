...
class cargarBalancesController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.contabilidad.cargarBalance.cargarExcel',['diarios'=>$diarios,'gruposPermiso'=>$gruposPermiso, 'PE'=>Punto_Emision::puntos()->get(),'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
            DB::rollBack();
