...
class categoriaClienteController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.ventas.categoriaCliente.index',['categoriaCliens'=>$categoriaCliens, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
    ...
    public function show($id)
    {
        try{
            ...
            if($categoriaClien){
                return view('admin.ventas.categoriaCliente.ver',['categoriaClien'=>$categoriaClien, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
    ...
    public function edit($id)
    {
        try{
            ...
            $categoriaClien = Categoria_Cliente::categoriaCliente($id)->first();
            if($categoriaClien){
                return view('admin.ventas.categoriaCliente.editar', ['categoriaClien'=>$categoriaClien, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
    ...
    public function delete($id)
    {
        try{
            ...
            $categoriaClien = Categoria_Cliente::categoriaCliente($id)->first();
            if($categoriaClien){
                return view('admin.ventas.categoriaCliente.eliminar',['categoriaClien'=>$categoriaClien, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
