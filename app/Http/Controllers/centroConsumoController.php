...
class centroConsumoController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            $centroCons = Centro_Consumo::centroConsumos()->get();
            $sustentosTributario25 = Sustento_Tributario::Sustentos()->get();           

            return view('admin.compras.centroConsumo.index',['sustentosTributario25'=>$sustentosTributario25,'centroCons'=>$centroCons, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
    ...
    public function store(Request $request)
    {
        try{            
            ...
            DB::commit();
            return redirect('centroConsumo')->with('success','Datos guardados exitosamente');
        }catch(\Exception $ex){
            DB::rollBack();
    ...
    public function show($id)
    {
        try{
            ...
            if($centroCon){
                return view('admin.compras.centroConsumo.ver',['centroCon'=>$centroCon, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
    ...
    public function edit($id)
    {
        try{
            ...
            $sustentosTributario25 = Sustento_Tributario::Sustentos()->get();
            if($centroCon){
                return view('admin.compras.centroConsumo.editar', ['sustentosTributario25'=>$sustentosTributario25,'centroCon'=>$centroCon, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
    ...
    public function delete($id)
    {
        try{
            ...
            $centroCon = Centro_Consumo::centroConsumo($id)->first();
            if($centroCon){
                return view('admin.compras.centroConsumo.eliminar',['centroCon'=>$centroCon, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
