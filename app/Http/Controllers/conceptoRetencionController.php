...
class conceptoRetencionController extends Controller
{
    ...
    public function index()
    {
        try{  
            ...
            return view('admin.sri.conceptoRetencion.index',['conceptoRetenciones'=>$conceptoRetenciones,'cuentas'=>$cuentas, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
    ...
    public function show($id)
    {
        try{
            ...
            if($conceptoRetencion){
                return view('admin.sri.conceptoRetencion.ver',['conceptoRetencion'=>$conceptoRetencion, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
    ...
    public function edit($id)
    {
        try{
            ...
            $cuentas = Cuenta::CuentasMovimiento()->get();
            if($conceptoRetencion){
                return view('admin.sri.conceptoRetencion.editar', ['conceptoRetencion'=>$conceptoRetencion,'cuentas'=>$cuentas, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{  
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
    ...
    public function delete($id)
    {
        try{
            ...
            $conceptoRetencion = Concepto_Retencion::conceptoRetencion($id)->first();
            if($conceptoRetencion){
                return view('admin.sri.conceptoRetencion.eliminar',['conceptoRetencion'=>$conceptoRetencion, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
