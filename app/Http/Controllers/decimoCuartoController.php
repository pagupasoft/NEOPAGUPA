    ...
    public function enviar(Request $request)
    {
        ...
        try {
            ...
            if ($request->get('idTipo') == 'Transferencia') {
                ...
                $diario->diario_beneficiario = "DECIMO CAURTO CONSOLIDADA DE EMPELADOS";
                ...
                $diario->diario_comentario = 'COMPROBANTE DE EMISION DEL DECIMO CUARTO CONSOLIDADA DE EMPLEADOS';
            ...
            if ($request->get('idTipo') == 'Transferencia') {
                ...
                $transferencia->transferencia_descripcion = 'PAGO DE DECIMO CUARTO CONSOLIDADA';
                $transferencia->transferencia_beneficiario ='PAGO DE DECIMO CUARTO CONSOLIDADA';
