...
class depositoCajaController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.caja.depositoCaja.index',['cajas'=>$cajas,'cajasxusuario'=>$cajasxusuario, 'sucursales'=>Sucursal::sucursales()->get(),'cuentas'=>Cuenta::CuentasMovimiento()->get(),'bancos'=>Banco::bancos()->get(),'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
