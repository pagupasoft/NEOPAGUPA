...
class descontarAnticipoClienteController extends Controller
{
    public function nuevo(){
        try{
            ...
            return view('admin.cuentasCobrar.descontarAnticipo.index',['bodegas'=>Bodega::Bodegas()->get(),'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
