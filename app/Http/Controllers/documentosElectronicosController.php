...
class documentosElectronicosController extends Controller
{
    public function nuevo()
    {
        try{
            ...
            return view('admin.sri.documentosElectronicos.index',['caduca'=>$data['validTo_time_t'],'sucursal'=>$sucursal,'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
