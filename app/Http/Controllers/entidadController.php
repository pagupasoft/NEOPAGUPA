...
class entidadController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.agendamientoCitas.entidad.index',['entidades'=>$entidades,'PE'=>Punto_Emision::puntos()->get(),'clientesAseguradoras'=>$clientesAseguradoras,'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
    ...
    public function show($id)
    {
        try{
            ...
            if($entidad){
                return view('admin.agendamientoCitas.entidad.ver',['entidad'=>$entidad, 'PE'=>Punto_Emision::puntos()->get(),'clientesAseguradoras'=>$clientesAseguradoras,'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
    ...
    public function edit($id)
    {
        try{
            ...
            $entidad = Entidad::Entidad($id)->first();
            if($entidad){
                return view('admin.agendamientoCitas.entidad.editar', ['entidad'=>$entidad, 'clientesAseguradoras'=>$clientesAseguradoras, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }catch(\Exception $ex){
