...
class entidadProcedimientoController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.agendamientoCitas.entidadProcedimiento.index',['clientesAseguradoras'=>$clientesAseguradoras,'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }catch(\Exception $ex){
    ...
    public function procedimientos($id)
    {
        try{
            ...
            if ($cliente) {
                return view('admin.agendamientoCitas.entidadProcedimiento.procedimientos',['especialidades'=>$especialidades,'entidades'=>$entidades,'cliente'=>$cliente,'PE'=>Punto_Emision::puntos()->get(), 'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            } else {
