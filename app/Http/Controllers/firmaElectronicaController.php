...
class firmaElectronicaController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.parametrizacion.firmaElectronica.index',['firmaElectronica'=>$firmaElectronica, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
