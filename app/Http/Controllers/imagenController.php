...
class imagenController extends Controller
{
    ...
    public function show($id)
    {
        try{
            ...
            $tipoImagenes=Tipo_Imagen::TipoImagenes()->get();
            if($imagen){
                return view('admin.citasMedicas.imagen.ver',['imagen'=>$imagen ,'tipoImagenes'=>$tipoImagenes ,'PE'=>Punto_Emision::puntos()->get(), 'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
    ...
    public function edit($id)
    {
        try{
            ...
            $tipoImagenes=Tipo_Imagen::TipoImagenes()->get();
            if($imagen){
                return view('admin.citasMedicas.imagen.editar',['imagen'=>$imagen,'tipoImagenes'=>$tipoImagenes,'PE'=>Punto_Emision::puntos()->get(), 'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function delete($id)
    {
        try{
            ...
            $tipoImagenes=Tipo_Imagen::TipoImagenes()->get();
            if($imagen){
                return view('admin.citasMedicas.imagen.eliminar',['imagen'=>$imagen,'tipoImagenes'=>$tipoImagenes,'PE'=>Punto_Emision::puntos()->get(), 'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
