...
class impuestoRentaRolController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.parametrizacion.impuestoRentaRol.view',['impuesto'=>$impuesto, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function show($id)
    {
        try{      
            ...
            if ($impuesto) {
                return view('admin.parametrizacion.impuestoRentaRol.ver', ['impuesto'=>$impuesto, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            } else {
                return redirect('/denegado');
            }
        }
    ...
    public function edit($id)
    {
        try{     
            ...
            $impuesto=Impuesto_Renta_Rol::rol($id)->first();
            if($impuesto){
                return view('admin.parametrizacion.impuestoRentaRol.editar',['impuesto'=>$impuesto, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function delete($id)
    {
        try{
            ...
            $impuesto=Impuesto_Renta_Rol::Rol($id)->first();
            if($impuesto){
                return view('admin.parametrizacion.impuestoRentaRol.eliminar',['impuesto'=>$impuesto, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
