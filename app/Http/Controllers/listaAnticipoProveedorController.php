...
class listaAnticipoProveedorController extends Controller
{
    public function nuevo()
    {
        try{  
            ...
            return view('admin.cuentasPagar.listaAnticipo.index',['proveedores'=>Proveedor::ProveedoresAnticipos()->get(),'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function buscar(Request $request){
        try{   
            ...
            return view('admin.cuentasPagar.listaAnticipo.index',['saldo_cero'=>$saldo_cero,'proveedorC'=>$request->get('proveedorID'),'pag'=>$totPag,'monto'=>$totMon, 'saldo'=>$totSal,'fCorte'=>$request->get('idCorte'),'datos'=>$datos,'proveedores'=>Proveedor::ProveedoresAnticipos()->get(),'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);      
        }catch(\Exception $ex){
