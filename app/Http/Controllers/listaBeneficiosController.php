...
class listaBeneficiosController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.recursosHumanos.listarbeneficios.index',['sucursales'=>$sucursales,'sucursalid'=>null,'fecha_desde'=>null,'fecha_hasta'=>null,'fecha_todo'=>null,'nombre_empleado'=>null,'empleado'=>$empleado,'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);   
        }
        catch(\Exception $ex){      
