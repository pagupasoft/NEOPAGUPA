...
class listaControlDiaController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.recursosHumanos.listaControlDia.index',['controles'=>null,'fechames'=>null,'nombre_empleado'=>null,'empleado'=>$empleado,'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);   
        }
        catch(\Exception $ex){      
    ...
    public function delete($id)
    {
        try{
            ...
            return view('admin.recursosHumanos.controlDias.eliminar',['anio'=>$anio,'mes'=>$mes,'detalle'=>$datos,'control'=>$control, 'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
            return redirect('listacontroldia')->with('error2','Ocurrio un error en el procedimiento. Vuelva a intentar. ('.$ex->getMessage().')');
        }
