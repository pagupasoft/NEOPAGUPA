...
class listaFaltanteCajaController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            return view('admin.caja.listaFaltanteCaja.index',['fechahasta'=>$fechahasta,'fechaDesde'=>$fechaDesde,'faltanteCajas'=>$faltanteCajas,'gruposPermiso'=>$gruposPermiso, 'PE'=>Punto_Emision::puntos()->get(),'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
            return redirect('inicio')->with('error2','Ocurrio un error en el procedimiento. Vuelva a intentar. ('.$ex->getMessage().')');
        }  
    ...
    public function show($id)
    {
        try{
            ...
            if($faltanteCaja){
                return view('admin.caja.listaFaltanteCaja.ver',['faltanteCaja'=>$faltanteCaja, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function delete($id)
    {
        try{
            ...
            if($faltanteCaja){
                return view('admin.caja.listaFaltanteCaja.eliminar',['faltanteCaja'=>$faltanteCaja,'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
