...
class listaProformaController extends Controller
{
    ...
    public function nuevo()
    {
        try{
            ...
            return view('admin.ventas.proforma.view',['sucursal'=>$sucursal,'reporteproforma'=>$proforma,'clientes'=>$clientes, 'puntoEmisiones'=>$puntoEmisiones,'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function consultar(Request $request)
    {
        try {
            ...
            return view('admin.ventas.proforma.view', ['sucursal'=>$sucursal,'idsucursal'=>$request->get('sucursal'),'fecha_desde'=>$request->get('fecha_desde'),'fecha_hasta'=>$request->get('fecha_hasta'),'fecha_todo'=>$request->get('fecha_todo'),'nombre_cliente'=>$valor_cliente,'reporteproforma'=>$reporteproforma, 'puntoEmisiones'=>$puntoEmisiones, 'clientes'=>$clientes,  'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        
        }catch(\Exception $ex){
            return view('admin.ventas.proforma.view',['reporteproforma'=>$reporteproforma, 'puntoEmisiones'=>$puntoEmisiones, 'clientes'=>$clientes,  'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin])->with('error2','Oucrrio un error en el procedimiento. Vuelva a intentar. ('.$ex->getMessage().')');
        }
    }
