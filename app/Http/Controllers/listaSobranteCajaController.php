...
class listaSobranteCajaController extends Controller
{
    ...
    public function index(Request $request)
    {
        try{
            ...
            return view('admin.caja.listaSobranteCaja.index',['fechahasta'=>$fechahasta,'fechaDesde'=>$fechaDesde,'gruposPermiso'=>$gruposPermiso, 'PE'=>Punto_Emision::puntos()->get(),'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function store(Request $request)
    {
        try{
            ...
            return view('admin.caja.listaSobranteCaja.index',['fechahasta'=>$fechahasta,'fechaDesde'=>$fechaDesde,'sobranteCajas'=>$sobranteCajas,'gruposPermiso'=>$gruposPermiso, 'PE'=>Punto_Emision::puntos()->get(),'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
            return redirect('inicio')->with('error2','Ocurrio un error en el procedimiento. Vuelva a intentar. ('.$ex->getMessage().')');
        }
    ...
    public function show($id)
    {
        try{
            ...
            if($sobranteCaja){
                return view('admin.caja.listaSobranteCaja.ver',['sobranteCaja'=>$sobranteCaja, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
    ...
    public function delete($id)
    {
        try{
            ...
            if($sobranteCaja){
                return view('admin.caja.listaSobranteCaja.eliminar',['sobranteCaja'=>$sobranteCaja,'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
