...
class listaquincenaConsolidadaController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.recursosHumanos.quincenaConsolidada.impresion',['quincena'=>$quincena,'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
