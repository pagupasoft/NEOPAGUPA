...
class listatransaccionCompraController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.compras.listatransaccionCompra.index',['proveedores'=>$proveedores,'sucursales'=>$sucursal,'compas'=>$compas, 'PE'=>Punto_Emision::puntos()->get(),'tipoPermiso'=>$tipoPermiso,'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function ver($id)
    {
        try{
            ...
            if (isset($compras->activo)) {
                return view('admin.compras.listatransaccionCompra.viewactivo', ['conceptosIva'=>Concepto_Retencion::ConceptosIva()->get(),'conceptosFuente'=>Concepto_Retencion::ConceptosFuente()->get(),'centros'=>Centro_Consumo::CentroConsumos()->get(),'cuentas'=>Cuenta::CuentasMovimiento()->get(),'sustentos'=>Sustento_Tributario::Sustentos()->get(),'comprobantes'=>Tipo_Comprobante::tipos()->get(),'compras'=>$compras, 'PE'=>Punto_Emision::puntos()->get(),'tipoPermiso'=>$tipoPermiso,'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }
            else{
                return view('admin.compras.listatransaccionCompra.view',['sustentos'=>Sustento_Tributario::Sustentos()->get(),'compras'=>$compras, 'PE'=>Punto_Emision::puntos()->get(),'tipoPermiso'=>$tipoPermiso,'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }    
