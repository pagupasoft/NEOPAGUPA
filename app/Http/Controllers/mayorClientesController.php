...
class mayorClientesController extends Controller
{
    public function nuevo()
    {
        try{ 
            ...
            return view('admin.contabilidad.mayorClientes.index',['cuentas'=>Cuenta::CuentasMovimiento()->get(),'clientes'=>Cliente::clientes()->get(),'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function buscar(Request $request){
        try{   
            ...
            return view('admin.contabilidad.mayorClientes.index',['cuentaC'=>$request->get('cuenta_id'),'cuentas'=>Cuenta::CuentasMovimiento()->get(),'clienteC'=>$request->get('clienteID'),'fDesde'=>$request->get('fecha_desde'),'fHasta'=>$request->get('fecha_hasta'),'datos'=>$datos,'clientes'=>Cliente::clientes()->get(),'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);      
        }catch(\Exception $ex){
