...
class mayorProveedoresController extends Controller
{
    public function nuevo()
    {
        try{ 
            ...
            return view('admin.contabilidad.mayorProveedores.index',['cuentas'=>Cuenta::CuentasMovimiento()->get(),'proveedores'=>Proveedor::proveedores()->get(),'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function buscar(Request $request){
        try{   
            ...
            return view('admin.contabilidad.mayorProveedores.index',['cuentaC'=>$request->get('cuenta_id'),'cuentas'=>Cuenta::CuentasMovimiento()->get(),'proveedorC'=>$request->get('proveedorID'),'fDesde'=>$request->get('fecha_desde'),'fHasta'=>$request->get('fecha_hasta'),'datos'=>$datos,'proveedores'=>Proveedor::proveedores()->get(),'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);      
        }catch(\Exception $ex){
