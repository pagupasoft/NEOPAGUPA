...
class modificarRolController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.RHCostaMarket.modificarRol.index',['fecha_desde'=>null,'fecha_hasta'=>null,'nombre_empleado'=>null,'empleado'=>$empleado,'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);   
        }
        catch(\Exception $ex){      
