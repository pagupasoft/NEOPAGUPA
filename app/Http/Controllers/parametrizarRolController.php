...
class parametrizarRolController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.parametrizacion.parametrizacionRol.index',['parametrizar'=>$parametrizar, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function show($id)
    {
        try{
            ...
            if($parametrizar){
                return view('admin.parametrizacion.parametrizacionRol.ver',['parametrizar'=>$parametrizar, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function edit($id)
    {
        try{
            ...
            $parametrizar=Parametrizar_Rol::rol($id)->first();
            if($parametrizar){
                return view('admin.parametrizacion.parametrizacionRol.editar',['parametrizar'=>$parametrizar, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function delete($id)
    {
        try{
            ...
            $parametrizar=Parametrizar_Rol::Rol($id)->first();
            if($parametrizar){
                return view('admin.parametrizacion.parametrizacionRol.eliminar',['parametrizar'=>$parametrizar, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
