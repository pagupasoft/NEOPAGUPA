...
class quincenaController extends Controller
{
    ...
    public function mision()
    {
        try{
            ...
            return view('admin.recursosHumanos.quincena.editemeision',['quincena'=>$quincena,'sucursales'=>Sucursal::sucursales()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
