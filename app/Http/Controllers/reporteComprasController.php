...
class reporteComprasController extends Controller
{
    public function nuevo()
    {
        try{
            ...
            return view('admin.sri.reporteCompras.index',['PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
