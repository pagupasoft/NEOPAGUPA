...
class reporteVentasController extends Controller
{
    public function nuevo()
    {
        try{
            ...
            return view('admin.sri.reporteVentas.index',['PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
