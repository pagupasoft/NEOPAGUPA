...
class sustentoTributarioController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.sri.sustentoTributario.index',['sustentoTributarios'=>$sustentoTributario, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function show($id)
    {
        try{
            ...
            if($sustentoTributario){
                return view('admin.sri.sustentotributario.ver',['sustentoTributario'=>$sustentoTributario, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
    ...
    public function edit($id)
    {
        try{
            ...
            $sustentoTributario=Sustento_Tributario::sustento($id)->first();
            if($sustentoTributario){
                return view('admin.sri.sustentoTributario.editar',['sustentoTributario'=>$sustentoTributario, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function delete($id)
    {
        try{
            ...
            $sustentoTributario=Sustento_Tributario::sustento($id)->first();
            if($sustentoTributario){
                return view('admin.sri.sustentoTributario.eliminar',['sustentoTributario'=>$sustentoTributario, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
