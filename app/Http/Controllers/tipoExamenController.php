...
class tipoExamenController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.citasMedicas.tipoExamen.index',['tiporecipientes'=>$tiposrecipientes,'tipomuestras'=>$tiposmuestras,'tiposExamen'=>$tiposExamen, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function show($id)
    {
        try{
            ...
            $tiposrecipientes=Tipo_Recipiente::Tipos()->get();
            if($tipoExamen){
                return view('admin.citasMedicas.tipoExamen.ver',['tiporecipientes'=>$tiposrecipientes,'tipomuestras'=>$tiposmuestras,'tipoExamen'=>$tipoExamen ,'PE'=>Punto_Emision::puntos()->get(), 'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
    ...
    public function edit($id)
    {
        try{
            ...
            $tiposrecipientes=Tipo_Recipiente::Tipos()->get();
            if($tipoExamen){
                return view('admin.citasMedicas.tipoExamen.editar',['tiporecipientes'=>$tiposrecipientes,'tipomuestras'=>$tiposmuestras,'tipoExamen'=>$tipoExamen ,'PE'=>Punto_Emision::puntos()->get(), 'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function delete($id)
    {
        try{
            ...
            $tiposrecipientes=Tipo_Recipiente::Tipos()->get();
            if($tipoExamen){
                return view('admin.citasMedicas.tipoExamen.eliminar',['tiporecipientes'=>$tiposrecipientes,'tipomuestras'=>$tiposmuestras,'tipoExamen'=>$tipoExamen ,'PE'=>Punto_Emision::puntos()->get(), 'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
