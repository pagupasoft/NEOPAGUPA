...
class tipoMovimientoBancoController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.bancos.tipoMovimientoBanco.index',['sucursales'=>Sucursal::sucursales()->get(),'cuentas'=>$cuentas,'tipoMovimientoBancos'=>$tipoMovimientoBancos, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function show($id)
    {
        try{
            ...
            if($tipoMovimientoBanco){
                return view('admin.bancos.tipoMovimientoBanco.ver',['tipoMovimientoBanco'=>$tipoMovimientoBanco, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function edit($id)
    {
        try{
            ...
            $cuentas=Cuenta::CuentasMovimiento()->get(); 
            if($tipoMovimientoBanco){
                return view('admin.bancos.tipoMovimientoBanco.editar',['sucursales'=>Sucursal::sucursales()->get(),'cuentas'=>$cuentas,'tipoMovimientoBanco'=>$tipoMovimientoBanco, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function delete($id)
    {
        try{
            ...
            $tipoMovimientoBanco=Tipo_Movimiento_Banco::tipoMovimiento($id)->first();  
            if($tipoMovimientoBanco){
                return view('admin.bancos.tipoMovimientoBanco.eliminar',['tipoMovimientoBanco'=>$tipoMovimientoBanco, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
