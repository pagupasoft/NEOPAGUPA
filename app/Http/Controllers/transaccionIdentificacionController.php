...
class transaccionIdentificacionController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return view('admin.sri.transaccionIdentificacion.index',['transaccionIdentificacion'=>$transaccionIdentificacion, 'PE'=>Punto_Emision::puntos()->get(),'tipoTransaccion'=>$tipoTransaccion,'tipoIdentificacion'=>$tipoIdentificacion,'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
        }
        catch(\Exception $ex){      
    ...
    public function show($id)
    {
        try{
            ...
            if($transaccionIdentificacion){
                return view('admin.sri.transaccionIdentificacion.ver',['transaccionIdentificacion'=>$transaccionIdentificacion, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
    ...
    public function edit($id)
    {
        try{
            ...
            $tipoIdentificacion = Tipo_Identificacion::TipoIdentificaciones()->get();
            if($transaccionIdentificacion){
                return view('admin.sri.transaccionIdentificacion.editar',['transaccionIdentificacion'=>$transaccionIdentificacion,'PE'=>Punto_Emision::puntos()->get(),'tipoTransaccion'=>$tipoTransaccion,'tipoIdentificacion'=>$tipoIdentificacion,'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
    ...
    public function delete($id)
    {
        try{
            ...
            $transaccionIdentificacion=Transaccion_Identificacion::TransaccionIdentificacion($id)->first();
            if($transaccionIdentificacion){
                return view('admin.sri.transaccionIdentificacion.eliminar',['transaccionIdentificacion'=>$transaccionIdentificacion, 'PE'=>Punto_Emision::puntos()->get(),'gruposPermiso'=>$gruposPermiso, 'permisosAdmin'=>$permisosAdmin]);
            }else{
                return redirect('/denegado');
            }
        }
