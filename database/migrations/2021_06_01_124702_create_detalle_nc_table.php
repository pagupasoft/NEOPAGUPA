...
class CreateDetalleNcTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detalle_nc', function (Blueprint $table) {
            $table->id('detalle_id');
            ...
            $table->bigInteger('nc_id');
            $table->foreign('nc_id')->references('nc_id')->on('nota_credito');
    ...
    {
        Schema::dropIfExists('detalle_nc');
    }
}
