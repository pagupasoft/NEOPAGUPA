...
class CreateDetalleRvTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detalle_rv', function (Blueprint $table) {
            $table->id('detalle_id');
            ...
            $table->foreign('retencion_id')->references('retencion_id')->on('retencion_venta');
    ...
    {
        Schema::dropIfExists('detalle_rv');
    }
}
