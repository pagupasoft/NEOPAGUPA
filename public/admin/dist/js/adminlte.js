...
(function (global, factory) {
  ...
  var SELECTOR_DATA_TOGGLE_THIS_CLOSE = '[data-widget="iframe-this-close"]';
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var newNavItem = "<li class=\"nav-item n-" + navId + "\" role=\"presentation\"><a class=\"nav-link\" data-toggle=\"row\" id=\"" + navId + "\" name=\"tab\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\"> <img src=\"admin/imagenes/LOGO-NEGRO-01.png\" class=\"marge-derecha-5\" style=\"width: 20px;\"/>" + title + "<button class=\"btn btn-xs\" id=\"n-" + navId + "\" data-widget=\"iframe-this-close\"><i id=\"n-" + navId + "\" name=\"close\" class=\"fas fa-times marge-izquierda-5\"></i></button></a></li>";
      $__default['default'](SELECTOR_TAB_NAVBAR_NAV).append(newNavItem);
      var newTabItem = "<div class=\"tab-pane fade n-" + navId + "\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><iframe src=\"" + link + "\"></iframe></div>";
    ...
    _proto.switchTab = function switchTab(item) {
      ...
      $__default['default'](SELECTOR_TAB_NAVBAR_NAV + " .tab-frame-neo").tab('dispose').removeClass('tab-frame-neo');

      this._fixHeight();

      $item.tab('show');
      $item.parents('li').addClass('active');
      $item.parents('li').addClass('tab-frame-neo');
    ...
    _proto.removeTab = function removeTab(id) {
      var $navItem = $__default['default'](SELECTOR_TAB_NAVBAR_NAV_ITEM + '.'+id+'.active');
      ...
      if($navItem[0]){
        ...
        var $navItem = $__default['default'](SELECTOR_TAB_NAVBAR_NAV_ITEM + '.'+id);
        var $navItemParent = $navItem.parent();
        var navItemIndex = $navItem.index();
      }

      $navItem.remove();
      $__default['default']('.tab-pane.'+id).remove();
    ...
    _proto.removeActiveTab = function removeActiveTab() {
      var $navItem = $__default['default'](SELECTOR_TAB_NAVBAR_NAV_ITEM + ".active"+ ".tab-frame-neo");
      var $navItemParent = $navItem.parent();
      var navItemIndex = $navItem.index();
      $navItem.remove();
      $__default['default']('.tab-pane.active').remove();
      $__default['default']('.tab-pane.tab-frame-neo').remove();
    ...
    _proto._setupListeners = function _setupListeners() {
      ...
      $__default['default'](document).on('click', SELECTOR_DATA_TOGGLE_THIS_CLOSE, function (e) {
        e.preventDefault();

        _this2.removeTab(e.target.id);
      });
  ...
  var SidebarSearch = /*#__PURE__*/function () {
    ...
    _proto.init = function init() {
      ...
      if ($__default['default'](SELECTOR_SEARCH_RESULTS).children(SELECTOR_SEARCH_LIST_GROUP).length == 0) {
        $__default['default'](SELECTOR_SEARCH_RESULTS).append($__default['default']('<div />', {
          class: CLASS_NAME_LIST_GROUP + ' nav-item'
        }));
      }
    ...
    _proto._renderItem = function _renderItem(name, link, path) {
      ...
      return "<a href=\"" + link + "\" class=\"list-group-item nav-link\">\n        <div class=\"search-title\">\n          " + name + "\n        </div>\n        <div class=\"search-path\">\n          " + path + "\n        </div>\n      </a>";
    };
