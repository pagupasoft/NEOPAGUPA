...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">¿Esta seguro de eliminar esta documento orden atencion?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('documentoOrdenAtencion.destroy', [$documentoOrdenA->documento_id]) }}">
                @method('DELETE')
                @csrf
