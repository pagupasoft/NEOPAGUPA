            ...
            <tr class="text-center" id="row_{ID}">
                ...
                <td>
                    <div class="input-group-prepend">
                        ...
                        <input type="number" class="input-group-text center" style="height:30px;" id="Pcosto{ID}" name="Pcosto[]" value="{Pcosto}" step="$"  readonly/></div></td>
                <td>
                    <div class="input-group-prepend">
                        <input type="text" class="input-group-text" style="width:40px; height:30px;" id="Ptipo{ID}" name="Ptipo[]" value="{Ptipo}" step="$" readonly/>
                        <input type="number" class="input-group-text" style="height:30px;" id="Pcobertura{ID}" name="Pcobertura[]" value="{Pcobertura}" step="0.01"  readonly/></div></td>
