...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">¿Esta seguro de eliminar este banco lista?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('bancoLista.destroy', [$bancoList->banco_lista_id]) }}">
                @method('DELETE')
                @csrf
