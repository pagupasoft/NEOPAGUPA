...
@section('principal')
<form class="form-horizontal" method="POST" action="{{ url("listaEgresoBancoanular") }} ">
@csrf
    <div class="card card-secondary col-sm-7">
        <div class="card-header">
            <h3 class="card-title">¿Esta seguro de eliminar este Egreso de Banco y Anular el cheque?</h3>
