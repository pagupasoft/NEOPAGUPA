...
@section('principal')
<form class="form-horizontal" method="POST" action="{{ url("notaDebitoBanco") }}" onsubmit="return validacion()">
    @csrf
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1" style="margin-bottom: 0px;">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="number" id="id_debe" name="id_debe" class="form-control centrar-texto" placeholder="0.00" value="0.00" step="any">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    @include ('admin.bancos.notaDebitoBancaria.itemAsiento')
