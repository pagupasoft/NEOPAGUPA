...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">¿Esta seguro de eliminar esta Amortizacion?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('amortizacion.destroy', [$seguro->amortizacion_id]) }}">
                @method('DELETE')
                @csrf
