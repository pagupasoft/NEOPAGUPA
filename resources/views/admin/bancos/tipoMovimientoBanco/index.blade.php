...
<div class="card card-secondary">
    ...
    <div class="card-body">
        <table id="example1" class="table table-bordered table-hover table-responsive sin-salto">
            ...
            <tbody>
                @foreach($tipoMovimientoBancos as $tipoMovimientoBanco)
                <tr class="text-center">
                    <td>                        
                        <a href="{{ url("tipoMovimientoBanco/{$tipoMovimientoBanco->tipo_id}/edit")}}" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fa fa-edit" aria-hidden="true"></i></a>
                        <a href="{{ url("tipoMovimientoBanco/{$tipoMovimientoBanco->tipo_id}")}}" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Ver"><i class="fa fa-eye"></i></a>                   
                    ...
                    @endif   
                    <td>{{ $tipoMovimientoBanco->sucursal->sucursal_nombre }}</td>                                                
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-secondary">
                <h4 class="modal-title">Nuevo Tipo de Movimiento Banco</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="form-horizontal" method="POST" action="{{ url("tipoMovimientoBanco") }}">
            @csrf
