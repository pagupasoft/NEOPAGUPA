            ...
            <tbody>
                ...
                <tr class="text-center">
                    <td>
                        ...
                        <a href="{{ url("caja/{$caja->caja_id}/edit") }}" class="btn btn-xs btn-primary"  data-toggle="tooltip" data-placement="top" title="Ediar"><i class="fa fa-edit" aria-hidden="true"></i></a>
