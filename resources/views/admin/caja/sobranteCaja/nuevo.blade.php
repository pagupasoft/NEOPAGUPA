...
@section('principal')
<form class="form-horizontal" method="POST" action="{{ url("sobranteCaja") }}">
    @csrf
    <div class="card card-secondary col-sm-8">
        <div class="card-header">
            <div class="row">
                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                    <h2 class="card-title">Nuevo Sobrante de Caja</h2>
                </div>
        ...
        <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                        ...
                        <input type="text" id="sobrante_serie" name="sobrante_serie"
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        <input type="text" id="sobrante_numero" name="sobrante_numero" value="{{ $secuencial }}" class="form-control  negrita " placeholder="Numero" required readonly>
                    </div>
                </div>
                <div class="form-group row">
