...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">¿Esta seguro de eliminar la tipo de movimiento de caja?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('tipoMovimientoCaja.destroy', [$tipoMovimientoCaja->tipo_id]) }}">
                @method('DELETE')
                @csrf
    ...
    <div class="card-body">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <label class="form-control">@if($tipoMovimientoCaja->cuenta) {{$tipoMovimientoCaja->cuenta->cuenta_numero.'  -  '.$tipoMovimientoCaja->cuenta->cuenta_nombre}} @else SIN CUENTA @endif</label>
                </div>
            </div>  
            @endif  
            <div class="form-group row">
