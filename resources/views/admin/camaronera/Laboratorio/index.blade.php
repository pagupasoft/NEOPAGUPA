                ...
                @if(isset($laboratorios))
                    ...
                    <tr class="text-center">
                        <td>
                            ...
                            <a href="{{ url("nauplio/{$laboratorio->laboratorio_id}") }}" class="btn btn-xs btn-secondary"  data-toggle="tooltip" data-placement="top" title="Lista de Nauplio"><i class="fa fa-list" aria-hidden="true"></i></a>
                        </td>
                        <td>{{ $laboratorio->laboratorio_nombre}}</td>
                        <td>{{ $laboratorio->laboratorio_Ubicacion}}</td>
                    </tr>
                    @endforeach
                @endif
            </tbody>
...
<div class="modal fade" id="modal-nuevo">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="{{ url("laboratorioC") }}">
            @csrf
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="idNombre" class="col-sm-3 col-form-label">Ubicacion </label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="idUbicacion" name="idUbicacion" placeholder="Ubicacion" required>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
