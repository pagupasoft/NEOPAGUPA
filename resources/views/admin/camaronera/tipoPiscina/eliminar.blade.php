...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">¿Esta seguro de eliminar el de tipo de Piscina?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('tipoPiscina.destroy', [$tipo->tipo_id]) }}">
                @method('DELETE')
                @csrf
