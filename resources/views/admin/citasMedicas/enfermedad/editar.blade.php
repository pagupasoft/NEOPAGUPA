...
@section('principal')
<form class="form-horizontal" method="POST" action="{{ route('enfermedad.update', [$enfermedad->enfermedad_id]) }}">
@method('PUT')
@csrf
    <div class="card card-secondary">
        ...
        <div class="card-body">
            <div class="form-group row">
                <label for="idCodigoEnf" class="col-sm-2 col-form-label">Codigo</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="idCodigoEnf" name="idCodigoEnf"  value="{{$enfermedad->enfermedad_codigo}}" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="idNombre" class="col-sm-2 col-form-label">Nombre</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="idNombre" name="idNombre"  value="{{$enfermedad->enfermedad_nombre}}" required>
                </div>
            </div>                              
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                        @if($enfermedad->enfermedad_estado=="1")
