...
@section('principal')
<form class="form-horizontal" onsubmit="return verificarDato();" method="POST" action="{{ url("anticipoProveedor") }}">
    @csrf
    <div class="card card-secondary col-sm-8">
        <div class="card-header">
            <div class="row">
                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                    <h2 class="card-title">Nuevo Anticipo de Proveedor</h2>
                </div>
        ...
        <div class="card-body">
            <h5 class="form-control" style="color:#fff; background:#17a2b8;">Datos de Cuenta</h5>
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="custom-select" id="cuenta_id" name="cuenta_id"  onclick="cargarContable();" required>
                                        <option value="" label>--Seleccione una opcion--</option>
                                    </select>
                                </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="form-group row">
                                <label for="idCliente" class="col-sm-2 col-form-label">Proveedor</label>
                                <div class="col-sm-10">
                                    <select class="custom-select select2" id="idProveedor" name="idProveedor" onchange="cargarBeneficiario();" required>
                                        <option value="" label>--Seleccione una opcion--</option>
