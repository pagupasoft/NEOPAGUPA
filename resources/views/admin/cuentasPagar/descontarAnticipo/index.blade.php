...
<div class="card card-primary card-outline">
    <form class="form-horizontal" method="POST" action="{{ url("descontarAntPro") }}" onsubmit="return validacion()">
        @csrf
        <div class="card-header">
            <div class="row">
                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                    <h2 class="card-title"><b>Cruza Anticipo con Factura de Proveedor</b></h2>
                </div>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="padding-top: 10px;">
                            ...
                            <div class="row clearfix form-horizontal">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="margin-bottom : 0px;">
                                    <div class="form-group">
                                        <input id="IdProveedor" name="IdProveedor" type="hidden" class="form-control">    
                                        <input id="nombreProveedor" name="nombreProveedor" type="text" class="form-control "
                                            placeholder="Proveedor" required readonly>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"
                            ...
                            <div class="row clearfix form-horizontal">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" style="margin-bottom : 0px;">
                                    <div class="form-group">
                                        <select id="proveedor_id" name="proveedor_id" class="form-control custom-select select2"
                                            data-live-search="true" onchange="limpiarTabla();">
                                            @foreach($proveedores as $proveedor)
                                            <option value="{{ $proveedor->proveedor_id }}">{{ $proveedor->proveedor_nombre }}
                                            </option>
                                            @endforeach
                                        </select>
                                    </div>
                    ...
                    <div class="row" id="tablaDetalleId">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 0px;">
                            <div class="table-responsive">
                                @include ('admin.cuentasPagar.descontarAnticipo.item')
...
<!-- /.card -->
@section('scriptAjax')
<script src="{{ asset('admin/js/ajax/autocompleteAnticipoProveedor.js') }}"></script>
@endsection
<script type="text/javascript">
    ...
    function cargarDetalle(idFactura){
        ...
        $.ajax({
            url: "{{ url("facturaCompraDetalle/searchN") }}",
            dataType: "json",
            type: "POST",
            data: {
    ...
    function cargarAnticipos(idProveedor){
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
            }
        ...
        $.ajax({
            url: '{{ url("anticiposProveedor/searchN") }}',
            dataType: "json",
            type: "POST",
            data: {
            ...
            success: function(data){
                for (var i=0; i<data.length; i++) {
                    ...
                    var fecha = data[i].anticipo_fecha.split('-');
                    linea = linea.replace(/{AFecha}/g, fecha[2] + "/" +fecha[1] + "/" + fecha[0]);
