    ...
    <table style="white-space: normal!important;" id="tabladetalle">>
        ...
        <tbody>                   
                    <tr class="letra10" style="border: 1px solid black;">              
                        ...
                        <td align="right">{{number_format($orden->orden_precio,2) }}</td>
                        <td align="right">{{number_format($orden->orden_cobertura,2)  }}</td>                   
                        <td align="right">{{number_format($orden->orden_copago,2) }}</td>
                    </tr>    
