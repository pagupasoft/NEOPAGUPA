...
@section('contenido')
    @section('titulo')
        <tr><td colspan="2" class="centrar letra15 negrita">ROL INDIVIDUAL</td></tr>
    @endsection
                ...
                <tr class="letra12">
                   ...
                   <tr class="letra12">
                    ...
                    <tr class="letra12">
                        <td class="detalle-diario"></td>
                        <td class="detalle-diario dereche"></td>
                        <td class="foot-rol detalle-diario">IESS :</td>
                        <td class="foot-rol-linea detalle-diario dereche">$ {{ number_format($detalle->detalle_rol_iess,2)}}</td>
                   </tr>
                   <tr class="letra12">
                    <td class="detalle-diario"></td>
                    <td class="detalle-diario dereche"></td>
                    <td class="foot-rol detalle-diario">IESS Asumido :</td>
                    <td class="foot-rol-linea detalle-diario dereche">$ {{ number_format($detalle->detalle_rol_iess_asumido,2)}}</td>
                     </tr>
                     <tr class="letra12">
                    <td class="detalle-diario"></td>
                    <td class="detalle-diario dereche"></td>
                    <td class="foot-rol detalle-diario">Total Anticipos :</td>
                    <td class="foot-rol-linea detalle-diario dereche">$ {{ number_format($detalle->detalle_rol_total_anticipo,2)}}</td>
                     </tr>
                     
                   <tr class="letra12">
                    <td class="detalle-diario"></td>
                    <td class="detalle-diario dereche"></td>
                    <td class="foot-rol detalle-diario">Imp. Renta :</td>
                    <td class="foot-rol-linea detalle-diario dereche">$ {{ number_format($detalle->detalle_rol_impuesto_renta,2)}}</td>
                    </tr>
                    <tr class="letra12">
                    <td class="detalle-diario"></td>
                    <td class="detalle-diario dereche"></td>
