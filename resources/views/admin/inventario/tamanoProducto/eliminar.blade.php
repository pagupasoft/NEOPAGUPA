...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">¿Esta seguro de eliminar este tamaño de producto?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('tamanoProducto.destroy', [$tamano->tamano_id]) }}">
                @method('DELETE')
                @csrf
