...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">¿Esta seguro de eliminar esta Unidad de Medida?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('unidadMedida.destroy', [$medida->unidad_medida_id]) }}">
                @method('DELETE')
                @csrf
