            ...
            @foreach($analisisuser as $ordenanalisisuser)
                ...
                <tr class="text-center">
                    <td> 
                        ...
                        <a href="{{ url("analisisLaboratorio/{$ordenanalisisuser->analisis_laboratorio_id}/resultados") }}" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="ATENDIDA"><i class="fas fa-notes-medical"></i></a> 
                        
                            @if($ordenanalisisuser->analisis_estado == 3)   
                                @if($count=='1')   
                                    <a href="{{ url("analisisLaboratorio/{$ordenanalisisuser->analisis_laboratorio_id}/enviar") }}" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="top" title="Enviar"><i class="fas fa-calendar-check"></i></a> 
                                @endif  
                            @endif       
                    </td>    
            ...
            @foreach($analisis as $ordenanalisis)
                ...
                <tr class="text-center">
                    <td> 
                        ...
                        <a href="{{ url("analisisLaboratorio/{$ordenanalisis->analisis_laboratorio_id}/resultados") }}" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="ATENDIDA"><i class="fas fa-notes-medical"></i></a> 
                        @if($ordenanalisis->analisis_estado == 3)   
                        <a href="{{ url("analisisLaboratorio/{$ordenanalisis->analisis_laboratorio_id}/enviar") }}" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="top" title="Enviar"><i class="fas fa-calendar-check"></i></a> 
                        @endif       
                    </td>    
