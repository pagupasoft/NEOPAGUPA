...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">¿Esta seguro de eliminar la parametrizacion contable?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('parametrizacionContable.destroy', [$parametrizacionContable->parametrizacion_id]) }}">
                @method('DELETE')
                @csrf
    ...
    <div class="card-body">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <label class="form-control">@if($parametrizacionContable->cuenta) {{$parametrizacionContable->cuenta->cuenta_numero.'  -  '.$parametrizacionContable->cuenta_nombre}} @else SIN CUENTA @endif</label>
                </div>
            </div>          
            <div class="form-group row">
