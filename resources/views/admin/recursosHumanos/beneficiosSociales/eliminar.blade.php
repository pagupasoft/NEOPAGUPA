...
<div class="card card-secondary">
    ...
    <h3 class="card-title">¿Esta seguro de eliminar datos del beneficios del empleado?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('beneficioSocial.destroy', [$beneficios->beneficios_id]) }}">
                @method('DELETE')
                @csrf
        ...
        <h5 class="form-control" style="color:#fff; background:#17a2b8;">Datos</h5>
            ...
            <div class="card-body">     
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="month" name="fecha_desde" id="fecha_desde" class="form-control" value='<?php echo(DateTime::createFromFormat('Y-m-d', ($beneficios->beneficios_fecha))->format('Y').'-'.DateTime::createFromFormat('Y-m-d', ($beneficios->beneficios_fecha))->format('m')); ?>' readonly>
                                
                            </div>
                            <div class="col-sm-2">
                            <input type="month" name="fecha_hasta" id="fecha_desde" class="form-control" value='<?php echo((DateTime::createFromFormat('Y-m-d', ($beneficios->beneficios_fecha))->format('Y'))."-".date("12")); ?>' readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="empleado_id" class="col-sm-2 col-form-label">Empleado</label>
                            <div class="col-sm-10">
                                <label class="form-control" id="idEmpleado" name="idEmpleado" >{{$beneficios->empleado->empleado_nombre}}</label>       
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <label class="form-control" id="idEmpleado" name="idEmpleado" >{{$beneficios->beneficios_fecha_emision}}</label>  
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <label class="form-control" id="idEmpleado" name="idEmpleado" >{{number_format($beneficios->beneficios_valor,2)}}</label>  
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="idMensaje" name="idMensaje" value="{{$beneficios->beneficios_descripcion}}" required readonly>
            ...
            <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <label class="form-control" id="idEmpleado" name="idEmpleado" >{{$beneficios->beneficios_tipo}}</label>  
                     <input type="hidden" id="idbeneficios" name="idbeneficios" value="{{$beneficios->beneficios_id}}"/>          
                    ...
                    <div class="form-group row">
                            ...
                            <label class="form-control" >
                                @if($beneficios->beneficios_tipo=="Cheque")
                                   {{$cheque->cuentaBancaria->banco->bancoLista->banco_lista_nombre}}
                                @endif
                                @if($beneficios->beneficios_tipo=="Transferencia")
