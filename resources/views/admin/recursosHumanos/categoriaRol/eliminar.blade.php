...
<div class="card card-secondary">
    <div class="card-header">
        <h3 class="card-title">¿Esta seguro de eliminar esta categoria de Rol?</h3>
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('categoriaRol.destroy', [$categoria->categoria_id]) }}">
                @method('DELETE')
                @csrf
