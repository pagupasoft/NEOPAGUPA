                        ...
                        <div class="row clearfix form-horizontal">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <div class="float-right">
                                    <form class="form-horizontal" method="POST" action="{{ route('controldiario.destroy', [$control->control_id]) }}">
                                        @method('DELETE')
                                        @csrf
