...
<div class="card card-secondary">
    <div class="card-header">
        ...
        <div class="float-right">
            <form class="form-horizontal" method="POST" action="{{ route('empleado.destroy', [$empleado->empleado_id]) }}">
                @method('DELETE')
                @csrf
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="form-control">{{$empleado->cuenta_nombre}}</label>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <label class="form-control">{{$empleado->departamento_nombre}}</label>
                    </div> 
                    <label for="idTipo" class="col-sm-3 col-form-label">Tipo Empleado</label>
                    <div class="col-sm-3">
                        <label class="form-control">{{$empleado->tipo->tipo_descripcion}} - @if(isset($empleado->tipo->sucursal_id)) {{$empleado->tipo->sucursal->sucursal_nombre}} @endif</label>
                    </div>                   
                </div>
                <div class="form-group row">
            ...
            <div class="tab-pane fade" id="adicional" role="tabpanel" aria-labelledby="adicional-tab">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <label class="form-control">{{$empleado->banco_lista_nombre}}</label>
                    </div>
                </div>
                <div class="form-group row">
