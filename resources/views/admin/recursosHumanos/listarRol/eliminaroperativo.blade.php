...
<div class="card card-primary ">
    <form method="POST" action="{{ route('rolConsolidado.destroy', $datos[1]['rol_id']) }}"> 
    @method('DELETE')
    @csrf
        <div class="row">
        <!-- Tabla de empelados -->
                ...
                <div class="col-sm-10">
                    <div  class="row">  
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <button type="button" onclick='window.location = "{{ url("listaroles") }}";' class="btn btn-default btn-sm"><i class="fa fa-undo"></i>&nbsp;Atras</button>
