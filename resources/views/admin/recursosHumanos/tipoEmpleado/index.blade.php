        ...
        <table id="example1" class="table table-bordered table-hover table-responsive sin-salto">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    <td>                        
                        <a href="{{ url("tipoEmpleado/{$tipoEmpleado->tipo_id}/edit") }}" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="top" title="Ediar"><i class="fa fa-edit" aria-hidden="true"></i></a>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-5 col-form-label"><CENTER>CUENTA DEBE</CENTER></label>
                            <label class="col-sm-5 col-form-label"><CENTER>CUENTA HABER</CENTER></label>
                        </div>
                        <div class="form-group row">
