...
<div class="card card-secondary">
    ...
    <div class="card-body">
        <h5 class="form-control" style="color:#fff; background:#17a2b8;">Datos</h5>
            <form class="form-horizontal" method="POST" action="{{ url("vacacion") }} "> 
            @csrf
            <div class="card-body">
                        <div class="row clearfix form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input id="rango_id" name="rango_id" value="{{ $rangoDocumento->rango_id }}"
                                            type="hidden">
                                        <input type="text" id="vacacion_serie" name="vacacion_serie"
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="vacacion_numero" name="vacacion_numero"
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select select2" id="idEmpleado" name="idEmpleado" onchange="empleado();" required>
                                    ...
                                    @foreach($empleados as $empleados)
                                            <option value="{{$empleados->empleado_id}}">{{$empleados->empleado_nombre}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control" value="0.00" min="0.01"  step="0.01" id="idValor" name="idValor" placeholder = "0.00" required>
                            </div>
                        </div>  
                        <div class="form-group row">
                            <label for="idMensaje" class="col-sm-2 col-form-label">Descripcion</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="idMensaje" name="idMensaje" value="" required>
                                <input type="hidden" class="form-control" id="descripcion" name="descripcion" value="" required>
                            </div>
                        </div>  
...
function empleado(){
     ...
     document.getElementById("idMensaje").value ="Vacacion de Empleado : "+ combo.options[combo.selectedIndex].text;
     document.getElementById("descripcion").value ="Vacacion de Empleado : "+ combo.options[combo.selectedIndex].text;
