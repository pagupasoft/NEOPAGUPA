...
<div class="card card-primary card-outline">
    <form class="form-horizontal" method="POST" action="{{ url("factura/proforma") }}">
        @csrf
            ...
            <div class="row">
                ...
                <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                    <div class="float-right">
                        ...
                        <button type="button" id="cancelarID" name="cancelarID" onclick='window.location = "{{ url("listaProforma") }}";'
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" id="factura_serie" name="factura_serie"
                                        ...
                                        <input id="proformafacturacion" name="proformafacturacion" value="{{ $facturaprofo->proforma_id}}"
                                        type="hidden">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row clearfix form-horizontal">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <input id="clienteID" name="clienteID" type="hidden" value="{{ $facturaprofo->cliente->cliente_id }}">
                                <input id="buscarCliente" name="buscarCliente"  type="text"  class="form-control "
                                    placeholder="Cliente" value="{{ $facturaprofo->cliente->cliente_nombre }}"  disabled required >
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="idCedula" name="idCedula" class="form-control "
                                        placeholder="Ruc"  value="{{ $facturaprofo->cliente->cliente_cedula }}"  disabled required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="idTipoCliente" name="idTipoCliente" class="form-control "
                                        placeholder="Tipo" value="{{ $facturaprofo->cliente->tipoCliente->tipo_cliente_nombre }}" disabled required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" style="margin-bottom : 0px;">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="idDireccion" name="idDireccion" class="form-control "
                                        placeholder="Direccion" value="{{ $facturaprofo->cliente->cliente_direccion }}" disabled required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="idTelefono" name="idTelefono" class="form-control "
                                        placeholder="Telefono" value="{{ $facturaprofo->cliente->cliente_telefono }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 form-control-label  "
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 alinear-izquierda" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <select id="bodega_id" name="bodega_id" class="form-control show-tick"
                                    data-live-search="true" >
                                    <option value="{{ $facturaprofo->bodega->bodega_id }}">{{ $facturaprofo->bodega->bodega_nombre }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <select class="form-control" id="factura_porcentaje_iva" name="factura_porcentaje_iva"
                                    ...
                                    <option value="{{ $facturaprofo->proforma_porcentaje_iva }}">{{ $facturaprofo->proforma_porcentaje_iva }}%
                                    </option>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-bottom: 0px;">
                            <div class="table-responsive">
                                @include ('admin.ventas.facturas.itemFacturaproforma')
                                                        ...
                                                        <div class="form-line">
                                                            <textarea id="factura_comentario" name="factura_comentario"
                                                                rows=3 class="form-control "
                                                                  placeholder="Escribir aqui..">Factura generado por la proforma N° {{ $facturaprofo->proforma_numero }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input id="idMontoCredito" type="number"
                                                                class="form-control "  placeholder="00" value="{{ $facturaprofo->cliente->credito->credito_nombre }}" required
                                                                disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <input id="idTipoCredito" type="text" class="form-control "
                                                                placeholder="00" value="{{ $facturaprofo->cliente->credito->credito_monto }}" required disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-control-label  "
...
function cargarmetodo() {
    ...
    foreach ($facturaprofo->detalles as $x) {
        ?>
        ...
        if( <?php echo $x->detalle_cantidad; ?> > <?php echo $x->producto->producto_stock; ?>){
            document.getElementById("id_cantidad").value='<?php echo $x->producto->producto_stock; ?>';
        }
        else{
...
function agregarItem2(id,cantidad,codigoproducto,nombre,tieneIva,precio,total) {
    ...
    total = Number(total);
    descuento = Number(0);
    var linea = $("#plantillaItemFacturaProforma").html();
