...
<div class="card card-primary card-outline">
    <form class="form-horizontal" method="POST" action="{{ url("guia/anular") }}">
        @csrf
        <div class="card-header">
            <div class="row">
                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                    <h2 class="card-title"><b>Guia de Remision</b></h2>
                </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <input id="gr_id" name="gr_id" value="{{ $guias->gr_id }}" type="hidden">
