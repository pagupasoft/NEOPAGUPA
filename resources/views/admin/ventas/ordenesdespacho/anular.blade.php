...
<div class="card card-primary card-outline">
    <form class="form-horizontal" action="{{ url("ordenDespacho/anular") }}" method="POST"  >
        @csrf
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row clearfix form-horizontal">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            <div class="form-group">
                                <div class="form-line">
                                    <label class="form-control" id="orden_numero" name="orden_numero"  value="{{$orden->orden_numero}}">{{$orden->orden_numero}}</label>   
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row clearfix form-horizontal">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7" style="margin-bottom : 0px;">
                            <div class="form-group">
                                <input id="orden_id" name="orden_id" type="hidden" value="{{$orden->orden_id}}" >
                                <input id="clienteID" name="clienteID" type="hidden">
                                <label class="form-control" id="buscarCliente" name="buscarCliente"  value="{{$orden->cliente->cliente_nombre}}">{{$orden->cliente->cliente_nombre}}</label>   
